	...
	public void sendPacket(DirectPacket packet) {
		...
		if (table.getTable().containsKey(packet.getDestination())) {
			...
			try {
				...
				e.printStackTrace();
				System.out
						.println("Oops... Something went wrong sending this packet.\nPlease try again.");
			}
		} else {
